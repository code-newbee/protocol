...
var file_geeker_geeker_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6e, 0x65, 0x77, 0x62, 0x65, 0x65, 0x2e, 0x67, 0x65,
	0x65, 0x6b, 0x22, 0x2f, 0x0a, 0x0f, 0x73, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
	...
	0x74, 0x49, 0x64, 0x22, 0x40, 0x0a, 0x10, 0x73, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52,
	...
	0x04, 0x43, 0x6f, 0x64, 0x65, 0x32, 0x51, 0x0a, 0x06, 0x47, 0x65, 0x65, 0x6b, 0x65, 0x72, 0x12,
	0x47, 0x0a, 0x08, 0x73, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x1c, 0x2e, 0x6e, 0x65,
	0x77, 0x62, 0x65, 0x65, 0x2e, 0x67, 0x65, 0x65, 0x6b, 0x2e, 0x73, 0x61, 0x79, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x6e, 0x65, 0x77, 0x62,
...
var file_geeker_geeker_proto_goTypes = []interface{}{
	(*SayHelloRequest)(nil),  // 0: newbee.geek.sayHelloRequest
	(*SayHelloResponse)(nil), // 1: newbee.geek.sayHelloResponse
}
var file_geeker_geeker_proto_depIdxs = []int32{
	0, // 0: newbee.geek.Geeker.sayHello:input_type -> newbee.geek.sayHelloRequest
	1, // 1: newbee.geek.Geeker.sayHello:output_type -> newbee.geek.sayHelloResponse
...
func (c *geekerClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/newbee.geek.Geeker/sayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Geeker_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/newbee.geek.Geeker/SayHello",
	}
...
var _Geeker_serviceDesc = grpc.ServiceDesc{
	ServiceName: "newbee.geek.Geeker",
